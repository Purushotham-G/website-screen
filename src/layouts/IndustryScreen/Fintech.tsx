            ...
            <Grid container>
                <Grid item xs={12} md={6}>
                  <Stack sx={{px:4, py:{md:2, xs:3}}}>
                    <img width="100%" height="100%" src={getAssetUrl('website/Fintech.jpg')} alt="no data icon"/>
                  </Stack>
                </Grid>
                <Grid item xs={12} md={6}>
                  <Stack sx={{py:{md:3, xs:2}, px:{md:8, xs:3}, gap:{md:2, xs:1}}} >
                    <Stack sx={{gap:2}}>
                        <Typography sx={{fontSize:{md:"32px", xs:"24px"}, fontWeight:"600"}}> <span style={{color:"#0085FF"}}>Fintech Services </span> Experience with AI Chatbots</Typography>
                        <Typography sx={{fontSize:{md:"18px", xs:"16px"}, fontWeight:"400", lineHeight:{md:"28px",xs:"24px"}, textAlign:"justify"}}>Empower your FinTech services with WhatsApp Business, offering immediate support and personalized financial guidance anytime, anywhere, enhancing user experience and trust</Typography>
                    </Stack>
