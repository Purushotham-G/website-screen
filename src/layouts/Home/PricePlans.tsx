              ...
              <Grid container>
                  <Grid item xs={12} md={2.6}>
                    <Grid container>
                      ...
                      <Stack sx={{flexDirection:{md:"column", xs:"row"}, px:{md:6, xs:0}, gap:{md:5, xs:0}}}>
                      ...
                      <Stack sx={{flexDirection:"row",alignItems:"center",px:{md:1}, py:{md:1}, borderRadius:"8px", border:"1px solid #0085FF1A",gap:{md:1, xs:1}, justifyContent:"center"}}>
                          ...
                          <Button variant='contained' disableElevation sx={{ fontWeight: 'bold', borderRadius: "5px", backgroundColor:"#0085FF", color:"#FFFFFF", textTransform:"none", fontSize:"14px" }}>Popular</Button>
                      </Stack>}
                      </Stack>
                  ...
                  {/* <Grid item xs={12} md={4.7}>
                    <Stack sx={{height:{md:"auto", xs:"auto", sm:"auto"}, backgroundColor:"#FFFFFF", gap:{md:3, xs:2, sm:3}, px:{md:10, xs:0, sm:6}, py:{md:7, xs:3}, borderRadius:{md:"10px 0px 0px 10px", xs:"10px 10px 10px 10px"}, boxShadow:"0px 0px 25px 0px rgba(0, 133, 255, 0.08);", alignItems:"flex-start"}}>
                      ...
                      <Stack sx={{}}>
                          <Typography sx={{fontWeight:"400", fontSize:{md:"18px", xs:"16px", sm:"17px"}}}>For small teams with moderate messaging volume</Typography>
                            <Stack sx={{flexDirection:"row"}}>
                              ...
                              <Stack sx={{justifyContent:"flex-end", pb:{md:1.5, xs:1}}}>
                  ...
                  <Grid item xs={12} md={4.7} sx={{pb:{md:0, xs:2}}}>
                    <Stack sx={{backgroundColor:"#EBF5FF", px:{md:7, xs:0, sm:5}, py:{md:6, xs:3, sm:4}, boxShadow:"0px 0px 25px 0px rgba(0, 133, 255, 0.08);", borderRadius:{md:" 0px 10px 10px 0px", xs:"10px 10px 10px 10px"}}}>
