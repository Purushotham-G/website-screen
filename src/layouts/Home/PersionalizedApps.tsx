...
export const PersionalizedApps = () => {
  ...
  return (
    <>
    <Stack>
        <Stack sx={{position:"relative",p:{md:4, xs:3} }}>
        ...
        <Stack sx={{position:"absolute", bottom:{md:"-75px",xs:"-20px"}, left:{md:"-110px", xs:"-40px"}}}>
          <img width={isMobile?"152px":"350px"} height={isMobile?"94px": "216px"}  src={getAssetUrl('screenshots/chatgpt.png')} alt="no data icon"/>
        </Stack>
        <Stack sx={{position:"absolute", bottom:{md:"-75px", xs:"-5px"}, right:{md:"0px", xs:"-35px"}}}>
